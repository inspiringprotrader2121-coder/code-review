...
CREATE TABLE IF NOT EXISTS review_run_usage (
  ...
  cache_write_tokens INTEGER NOT NULL DEFAULT 0 CHECK (cache_write_tokens >= 0 AND cached_input_tokens + cache_write_tokens <= input_tokens),
  output_tokens INTEGER NOT NULL DEFAULT 0 CHECK (output_tokens >= 0),
  ...
  cache_write_rate_per_m REAL NOT NULL DEFAULT 0 CHECK (cache_write_rate_per_m >= 0),
