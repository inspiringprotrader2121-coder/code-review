...
export function loadReviewRuntimeConfig(
  ...
  const config: ReviewRuntimeConfig = {
    ...
    promptChangedChars: promptLimit(env.ORVEX_MAX_CHANGED_CHARS, 64_000),
    promptRelatedChars: promptLimit(env.ORVEX_MAX_RELATED_CHARS, 24_000),
    promptOtherChars: promptLimit(env.ORVEX_MAX_OTHER_CHARS, 8_000),
