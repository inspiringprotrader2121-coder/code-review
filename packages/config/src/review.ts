...
export function loadReviewRuntimeConfig(
  ...
  const config: ReviewRuntimeConfig = {
    ...
    promptChangedChars: Math.min(32_000, promptLimit(env.ORVEX_MAX_CHANGED_CHARS, 32_000)),
    promptRelatedChars: Math.min(12_000, promptLimit(env.ORVEX_MAX_RELATED_CHARS, 12_000)),
    promptOtherChars: Math.min(4_000, promptLimit(env.ORVEX_MAX_OTHER_CHARS, 4_000)),
