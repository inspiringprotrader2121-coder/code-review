  ...
  return (
    ...
    Object.freeze({
      ...
      usageCosts: Object.freeze({
        ...
        deepseek: Object.freeze({ input: 0.66, cachedInput: 0.022, output: 1.98 }),
        'deepseek-flash': Object.freeze({ input: 0.22, cachedInput: 0.007, output: 0.66 }),
        modelRates: Object.freeze({
          'gpt-5.6-luna': Object.freeze({ input: 1, cachedInput: 0.1, output: 6 }),
          'deepseek-v4-pro': Object.freeze({ input: 0.66, cachedInput: 0.022, output: 1.98 }),
          'deepseek-v4-flash': Object.freeze({ input: 0.22, cachedInput: 0.007, output: 0.66 }),
...
export async function processReviewJob(
  ...
  if (admitted.kind === 'deferred') {
    return {
      ...
      fixedCount: 0,
      skipReason:
        admitted.reason === 'rate_limited' ? 'rate_limited_deferred' : 'concurrency_deferred',
    };
  }
